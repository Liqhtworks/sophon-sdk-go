...
type JobResponse struct {
	...
	// Concrete profile resolved by the worker. Omitted until dispatch resolves. On explicit-profile jobs this equals `profile`; on `sophon-auto` jobs it is an internal adaptive profile ID. 
